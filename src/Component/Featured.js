...
const Featured = () => {
  ...
  return (
    <>
    <div className='baner-featured-news-home col-sm-3 '>
                       <div className='banner-new-item-home-img position-relative ' >
                         ...
                         <ReactStars
                               count={5}
                                  ...
                                  edit={false}
                                        />
                         <span>$100.00</span>
                         <div className='icons-banner-feature position-absolute'>
